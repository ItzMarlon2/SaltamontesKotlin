...
class RegistroActivity : AppCompatActivity() {
    ...
    private fun iniciarComponentes(){
        ...
        val botonSalir: Button =findViewById(R.id.btn_salir)
        botonSalir.setOnClickListener{isFinish()}
    ...
    private fun onClick(Boton : Int) {
            ...
            try {
                ...
                est.telefono = campTelefono?.text.toString().toInt()
                ...
                if(est.nota1 >5 || est.nota2>5 || est.nota3>5 || est.nota4>5 || est.nota5>5){
                ...
                }else if (est.nombre.isNullOrBlank() || est.documento.isNullOrBlank() || est.direccion.isNullOrBlank() ||
                    ...
                    when (Boton) {
                        1 -> {
                            ...
                            miBundle.putInt("Telefono", est.telefono)
